...
#define SETTINGS_GROUP_XBMC TEXT("XBMC")
#define SETTINGS_XBMC_IP    TEXT("XbmcIp")
...
/*string*/
#define SET_SETTINGS_STRING( SETTING_GROUP, SETTING_NAME, SETTING_VARIABLE ) \
  if ( !pSettingsManager->IsSettingExists( SETTING_GROUP, SETTING_NAME ) ) \
    pSettingsManager->SetStringSetting( SETTING_GROUP, SETTING_NAME, SETTING_VARIABLE ); \
  else \
    OnSettingsChanged( SETTING_GROUP, SETTING_NAME );

#define IF_SETTING_CHANGED_STRING( SETTING_GROUP, SETTING_NAME, SETTING_VARIABLE ) \
  if ( SettingName == SETTING_NAME ) \
    SETTING_VARIABLE = pSettingsManager->GetStringSetting( SETTING_GROUP, SETTING_NAME );
