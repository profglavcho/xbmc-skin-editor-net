...
public:
   ...
   */
   ...
   // remove all entries
	...
	{
		CSADirEntry()	{}
		CSADirEntry(const CStdStringA &s)
		{
			m_sName = s;
		}
		CStdStringA m_sName;
...
protected:
	...
	bool	GetSubDirs(SADirVector &dir_array, const CStdStringA &path);
	UINT	FindFiles(const CStdStringA & dir, const CStdStringA & filter, bool bIncludeFilesInFileList, bool bIncludeFoldersInFileList);
	void	FormatPath(CStdStringA &path);

	CStdStringA	m_sSourceDir;
